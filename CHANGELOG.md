...
- 时间情报导航与信号范围筛选：桌面端五个时间情报子视图改为左侧纵向导航，900px 以下回退为顶部横向滚动；市场信号新增全部时间、近 7/30/90 天和近 1 年筛选，能力域计数随时间窗联动；新增完整信号列表 API，移除信号页 500/2000 条硬截断，7,474 条历史信号继续按每批 50 条渐进渲染。
