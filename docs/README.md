...
| 项目 | 状态 |
| --- | --- |
| 当前阶段 | T1-T3 主体完成；T4 部署类待做；人工标注 0/100 待回流 |
| 已完成 | 数据全链路（D0-D9）· 三大主案例 · 岗位版本发布（ai-agent-v2）· 人岗诊断（21 候选人）· 后端 API 9 端点 · 前端 7 页真实数据 · PostgreSQL 12 表 6645 证据 |
| 下一步 | F-T3.4/3.6 前端接线 · Docker Compose + CI · 人工标注回流 · Neo4j 投影 |
| 当前阻塞 | 人工标注 0/100（阻塞 D3/D5/D9 退出条件） |
