...
15. [参赛提交方案](submission.md)：官方赛题 XH-202621 的作品设计实现方案（提交文档）。
16. [前端设计参考](design-references.md)：外部平台调研、AI 交互模式和可迁移设计规则。
17. [架构决策记录](adr/README.md)：不可逆技术和数据决策。
18. [研究资料](research/README.md)：发榜方契合度、竞品和产品取舍。
...
| 项目 | 状态 |
| --- | --- |
| 当前阶段 | T1-T4 主体完成；三项硬指标达线（97/98/100）；待提交材料（PPT/视频/案例包） |
| 已完成 | 数据全链路（D0-D9）· 三大主案例 · 岗位版本发布（12 岗位 17 版本）· 人岗诊断（21 候选人）· 后端 API 31 路由 · 前端 26 页 · PostgreSQL 27 表 14174 证据 · 三项准确率 97%/98%/100% 达标 |
| 下一步 | 提交材料（PPT/视频/案例包）· 双人复核（B-T4.10）· Neo4j 投影查询切换 |
